  ...
  return (
    <div className='px-4 lg:px-24 my-20 flex flex-col md:flex-row justify-between items-center gap-14'>
      ...
      <div className='md:w-1/2 space-y-6'>
        ...
        <p className='mb-10 tect-lg md:w-5/6'>Lorem ipsum dolor sit amet consectetur adipisicing elit.
         Quae ducimus nisi quaerat ab numquam minus est natus,
         commodi modi temporibus ipsam quidem, voluptate dolor sunt eius at totam debitis.
         Laboriosam, officia neque. Enim vel libero repellendus culpa obcaecati reiciendis laboriosam!</p>
